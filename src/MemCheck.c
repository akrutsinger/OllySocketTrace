...
/*
 * replacement call for HeapAlloc
 */
...
/*
 * replacement call for HeapFree
 */
int xHeapFree(void *heap, unsigned long flags, void *addr)
{
	remove_mem_info(addr);
    return HeapFree(heap, flags, addr);
}
